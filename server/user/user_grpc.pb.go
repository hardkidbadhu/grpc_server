...
const (
	Inventory_GetUserList_FullMethodName = "/Inventory/GetUserList"
)
...
func (c *inventoryClient) GetUserList(ctx context.Context, in *GetUserListRequest, opts ...grpc.CallOption) (*GetUserListResponse, error) {
	out := new(GetUserListResponse)
	err := c.cc.Invoke(ctx, Inventory_GetUserList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedInventoryServer) GetUserList(context.Context, *GetUserListRequest) (*GetUserListResponse, error) {
...
func _Inventory_GetUserList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServer).GetUserList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Inventory_GetUserList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServer).GetUserList(ctx, req.(*GetUserListRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Inventory_GetUserList_Handler,
		},
	},
